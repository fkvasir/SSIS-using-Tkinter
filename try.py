...
button_add_course = customtkinter.CTkButton(app, text="Add Course", command=add_course)
button_add_course.pack(pady=5)

button_show_courses = customtkinter.CTkButton(app, text="Show Courses", command=show_courses)
...
#         frame_edit = ctk.CFrame(window_edit)
#         frame_edit.pack(pady=20)

#         label_name = ctk.CLabel(frame_edit, text="Student Name:")
#         label_name.grid(row=0, column=0)
#         entry_name = ctk.CEntry(frame_edit)
#         entry_name.grid(row=0, column=1)
#         entry_name.set_text(selected_name)

#         label_courses = ctk.CLabel(frame_edit, text="Courses:")
#         label_courses.grid(row=1, column=0)
#         entry_courses = ctk.CEntry(frame_edit)
...
#         button_save = ctk.CButton(window_edit, text="Save Changes", command=save_changes)
...
# button_save_selection = customtkinter.CTkButton(app, text="Save Selection", command=save_selection)
...
# button_remove_data = customtkinter.CTkButton(frame_buttons, text="Remove Data", command=remove_data)
# button_remove_data.grid(row=0, column=0, padx=5)

# button_edit_data = customtkinter.CTkButton(frame_buttons, text="Edit Data", command=edit_data)
...
# button_search = customtkinter.CTkButton(app, text="Search", command=search_data)
